...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/rules/rulesModule.js',
			'app/modules/rules/rulesCtrl.js',
			'app/modules/rules/rulesRoute.js',
			'app/modules/rules/rulesService.js',
			'app/modules/rules/rules-test.js',
			'app/modules/map/mapModule.js',
			'app/modules/map/mapCtrl.js',
			'app/modules/map/mapRoute.js',
			'app/modules/map/mapService.js',
			'app/modules/map/map-test.js',
		],
